...
export const COLOR_GUESS_EXAMPLES: ReactNode[] = [
  ...
  <div className="flex items-center justify-center gap-3 rounded-xl bg-red-50 p-4">
    <div
      className="h-14 w-14 rounded-full border-4 border-red-300"
...
export const LETTER_SOUNDS_EXAMPLES: ReactNode[] = [
  null,
  <div className="flex items-center justify-center gap-3 rounded-xl bg-emerald-50 p-4">
    <div className="flex h-14 w-14 items-center justify-center rounded-xl border-4 border-emerald-300 bg-emerald-100 text-3xl font-bold text-emerald-700">
      🔊
    </div>
    <ArrowRight className="text-emerald-500" />
    <Slot tone="green">B</Slot>
  </div>,
  null,
];

export const COLOR_SORTING_EXAMPLES: ReactNode[] = [
  <div className="flex items-center justify-center gap-3 rounded-xl bg-red-50 p-4">
    <div
      className="h-12 w-12 rounded-full border-4 border-red-300"
      style={{ backgroundColor: "#FF0000" }}
    />
    <ArrowRight className="text-red-500" />
    <div
      className="flex h-14 w-14 items-center justify-center rounded-2xl border-4 border-red-300 bg-red-100 text-2xl"
      aria-hidden="true"
    >
      🧺
    </div>
...
export const COLORING_EXAMPLES: ReactNode[] = [
  ...
  <div className="flex items-center justify-center gap-3 rounded-xl bg-pink-50 p-4">
    <div
      className="h-12 w-12 rounded-lg border-4 border-purple-300"
